...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: AuthLoadingPageWidget.routeName,
          path: AuthLoadingPageWidget.routePath,
          builder: (context, params) => AuthLoadingPageWidget(),
        )
