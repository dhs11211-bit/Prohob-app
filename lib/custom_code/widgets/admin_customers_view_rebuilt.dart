...
class _AdminCustomersViewState extends State<AdminCustomersView> {
  ...
  void _showCreateJobModal() {
    ...
    TextEditingController recurringIntervalCtrl = TextEditingController(text: "1");
    List<int> recurringDaysOfWeek = []; // 0=Sun..6=Sat
    String recurringEndType = "never";
    TextEditingController recurringEndOccurrencesCtrl = TextEditingController(text: "1");
    DateTime? recurringEndDate;
    bool skipWeekends = false;
    bool autoNotifyCustomer = false;
